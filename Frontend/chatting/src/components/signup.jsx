...
export const Registerpage = () => {
  ...
  const Register = async (e) => {
    ...
    setloading(true)
    try{
  const response =    await fetch('https://anonymous-chat-1.onrender.com/register',{
        method:'POST',
        headers:{
    ...
    return(
      ...
      <form onSubmit={Register} className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
